  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <p> purchase request with ID <span class="highlight">${requestDisplayId}</span> titled "<strong>${title}</strong>" has provided more information information. Below are the details of the request:</p>
