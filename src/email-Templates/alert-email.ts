...
<head>
  ...
  <title>Purchase Request On Hold</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Purchase Request On Hold</h1>
    <p>Dear Sir/Mam<strong></strong>,</p>
    <p>This purchase request with ID <span class="highlight">${requestDisplayId}</span> titled "<strong>${title}</strong>" has been placed on hold by ${name}.</p>
  <p>The reason for this hold is as follows:</p>
  <p class="reason">"${commentMessage}"</p>
   ...
   <!-- <p>Receiver Details<strong></strong>,</p> -->
    ...
    <table class="details-table">
      ...
      <tr>
        <th>Quantity</th>
      <!--  <td>${quantity}</td> -->
        <td>${quantity !== null && quantity !== undefined ? quantity : 0} ${unit.unitName !== null && unit.unitName !== undefined ? unit.unitName : ''} </td>
      </tr>
      <tr>
