...
<body>
  <div class="container">
    <h1>New Purchase Request initaited</h1>
    <p>Dear Sir/Mam<strong></strong>,</p>
    <p>This purchase request with ID <span class="highlight">${requestDisplayId}</span> titled "<strong>${title}</strong>" has been generated by ${name}.</p>
